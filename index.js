...
async function askQuestion() {
    ...
    if (answers.operator == "Addition") {
        console.log(chalk.green(`\n> ${answers.Number01} + ${answers.Number02} = ${answers.Number01 + answers.Number02}\n`));
    }
        ...
        console.log(chalk.green(`\n> ${answers.Number01} / ${answers.Number02} = ${(answers.Number01 / answers.Number02).toFixed(3)}\n`));
    }
    else if (answers.operator == "Power") {
        console.log(chalk.green(`\n> ${answers.Number01} ^ ${answers.Number02} = ${Math.pow(answers.Number01, answers.Number02).toFixed(3)}\n`));
    }
}
